 ...
 * @shelf Suzn
 */
public class ShelfDAOImpl extends UnicastRemoteObject implements ShelfDAO {
     ...
     */
    public ShelfDAOImpl(Gson gson, String filename) throws RemoteException {
        this.gson = gson;
     ...
     */
    @Override
    public synchronized boolean isShelfAvailable(Shelf shelf) throws RemoteException {
        try {
     ...
     */
    @Override
    public synchronized int save(Shelf t) throws RemoteException {
     ...
     */
    @Override
    public synchronized int append(Shelf t) throws RemoteException {
     ...
     */
    @Override
    public synchronized int update(Shelf t) throws RemoteException {
     ...
     */
    @Override
    public synchronized int remove(Shelf t) throws RemoteException {
     ...
     */
    @Override
    public synchronized Shelf findById(int id) throws RemoteException {
     ...
     */
    @Override
    public synchronized List<Shelf> findAll() throws RemoteException {
