 ...
 * @transaction Suzn
 */
public class TransactionDAOImpl extends UnicastRemoteObject implements TransactionDAO {
     ...
     */
    public TransactionDAOImpl(Gson gson, String filename) throws RemoteException {
        this.gson = gson;
     ...
     */
    @Override
    public synchronized boolean isTransactionAvailable(Transaction transaction) throws RemoteException {
        try {
     ...
     */
    @Override
    public synchronized int save(Transaction t) throws RemoteException {
        try {
     ...
     */
    @Override
    public synchronized int append(Transaction t) throws RemoteException {
     ...
     */
    @Override
    public synchronized int update(Transaction t) throws RemoteException {
     ...
     */
    @Override
    public synchronized int remove(Transaction t) throws RemoteException {
     ...
     */
    @Override
    public synchronized Transaction findById(int id) throws RemoteException {
     ...
     */
    @Override
    public synchronized List<Transaction> findAll() throws RemoteException {
