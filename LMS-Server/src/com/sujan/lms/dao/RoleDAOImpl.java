...
import com.sujan.lms.common.dao.RoleDAO;
...
public  class RoleDAOImpl extends UnicastRemoteObject implements RoleDAO {
     ...
     */
    public RoleDAOImpl(Gson gson, String filename) throws RemoteException {
        this.gson = gson;
     ...
     */
    @Override
    public synchronized int save(Role t) throws RemoteException {
     ...
     */
    @Override
    public synchronized int append(Role t) throws RemoteException {
     ...
     */
    @Override
    public synchronized int update(Role t) throws RemoteException {
     ...
     */
    @Override
    public synchronized int remove(Role t) throws RemoteException {
     ...
     */
    @Override
    public synchronized Role findById(int id) throws RemoteException {
     ...
     */
    @Override
    public synchronized List<Role> findAll() throws RemoteException {
