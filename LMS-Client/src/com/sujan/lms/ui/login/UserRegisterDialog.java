...
public class UserRegisterDialog extends javax.swing.JDialog {
    ...
    jPanel5Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {courseTextField, emailTextField, tpNumberTextField});
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        if (validation.isUserRegisterFormValid(nameTextField.getText(), userTextField.getText(),
                emailTextField.getText(), tpNumberTextField.getText(), dobDateChooser.getSelectedDate(),
                courseTextField.getText(), yearTextField.getText(), String.valueOf(passwordField.getPassword()), String.valueOf(confirmPasswordField.getPassword()))) {
            ...
            user.setTpNumber(tpNumberTextField.getText());
            user.setDob(dobDateChooser.getSelectedDate().getTimeInMillis());
            user.setCourse(courseTextField.getText());
            user.setYear(Integer.valueOf(yearTextField.getText()));
            user.setEmail(emailTextField.getText());
            user.setRole(new Role(RoleParams.ROLE_LIBRARIAN, RoleParams.LIBRARIAN));
            ...
            try {
                ...
                this.dispose();
                    ...
                    | CorruptedDataException | DuplicateRecordException
